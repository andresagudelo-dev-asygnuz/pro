...
6. **`docs/intake/00-indice-y-alcance.md`** — entrada al contexto de negocio (estándar `00–08`). En PRO, el detalle vive aún en **`PRO-gestion.documental.md`** hasta migrar por secciones.
