...
| G5 | QA | **En curso — Fase 2** | 2026-04-30 | — | Fase 1 (Técnico) **Aprobada**: 188/188 tests unitarios PASS; 11/11 scripts SQL PASS sobre Supabase local. Hotfixes aplicados para recursión RLS y orden de migraciones. Fase 2 (E2E) pendiente de grabación manual por el fundador. |
