...
| G4 | Desarrollo | **En curso — Sprint 5** | 2026-04-28 | — | Sprint 1–3 cerrados (HU-001/002/003 + módulo lateral matches/venues/notifications). Sprint 4: codebase estabilizado (ESLint + Build OK), CI/CD corregido (pnpm lockfile), landing premium + market validation, **HU-004 Torneos restaurada** (regresión por merge de landing). Sprint 5 en curso: **HU-005 Inscripciones (RF-004)** con `teams` / `team_members` / `tournament_registrations`, trigger atómico de cupos, gate de verificación de edad. Pendiente: HU-006 Resultados/Standings. |
