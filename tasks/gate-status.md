...
| G4 | Desarrollo | **En curso — Sprint 4** | 2026-04-28 | — | Sprint 1–3 cerrados (HU-001/002/003 + módulo lateral matches/venues/notifications). Sprint 4: codebase estabilizado (ESLint + Build OK), CI/CD corregido (pnpm lockfile), landing premium + market validation. **HU-004 Torneos restaurada** (regresión por merge de landing) en este sprint. Pendientes Sprint 5: HU-005 Inscripciones y HU-006 Resultados/Standings. |
