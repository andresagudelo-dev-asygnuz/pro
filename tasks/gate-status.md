...
| G4 | Desarrollo | **En curso — Sprint 1** | 2026-04-17 | — | Sprint 1 activo: PR A (DB foundation, #10) ✓, PR B (registro con rol, #11) ✓, PR C (verificación de edad, #13) ✓ mergeados; **PR D (admin approval queue) en revisión**. Plan: `tasks/sprint-week-01.md`. |
