...
| G4 | Desarrollo | **En curso — Sprint 2** | 2026-04-25 | — | Sprint 1 cerrado. Sprint 2: PR A (DB foundation), PR B (Bloque 1), PR C (Bloques 2-4 + Preview) completados. PR D (Vista pública /u/[slug]) implementado y verificado. Sprint 2 completado. |
