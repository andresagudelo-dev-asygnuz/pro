...
import { LocalFocusSection } from "./LocalFocusSection"
    ...
    <div className="min-h-screen">
      ...
      <footer className="bg-zinc-100 dark:bg-zinc-950 py-16 border-t border-zinc-200 dark:border-white/5 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-zinc-600 dark:text-zinc-400 font-bold mb-2 uppercase tracking-widest text-xs">Vive el deporte como un profesional</p>
