    ...
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <h1 className="mt-4 text-2xl font-bold text-zinc-900 dark:text-white">Crear cuenta</h1>
          <p className="mt-1 text-sm text-muted-foreground">Únete a la plataforma deportiva</p>
        </div>
