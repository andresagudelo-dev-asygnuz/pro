...
export function LocalFocusSection() {
  return (
    <section className="relative py-24 bg-zinc-950 overflow-hidden">
      <div className="absolute inset-0 bg-[url('/pitch-aerial.png')] bg-fixed bg-cover bg-center opacity-20" />
      ...
      <div className="container mx-auto relative z-10 px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative group w-full aspect-video lg:aspect-square lg:h-full min-h-[400px] lg:min-h-[500px]">
            <div className="absolute top-[40%] left-[45%] w-4 h-4 bg-brand-secondary rounded-full animate-ping z-20 shadow-[0_0_15px_#00B5D8]" />
            <div className="absolute top-[55%] left-[60%] w-4 h-4 bg-brand-primary rounded-full animate-ping z-20 [animation-delay:700ms] shadow-[0_0_15px_#6B46C1]" />
            <div className="absolute top-[30%] left-[55%] w-4 h-4 bg-brand-accent rounded-full animate-ping z-20 [animation-delay:1000ms] shadow-[0_0_15px_#FFD700]" />

            <GlassContainer className="p-2 border-white/30 shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden h-full min-h-[500px] transition-transform duration-700 bg-black/40">
              <iframe
