...
ALTER TABLE public.tournament_registrations DISABLE TRIGGER tr_before_insert_capacity;
...
ALTER TABLE public.tournament_registrations ENABLE TRIGGER tr_before_insert_capacity;
