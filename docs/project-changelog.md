...
- `[Construcción]` **G4 Sprint 3 iniciado (MVP Fútbol)**: Implementación de flujo de aprobación de jugadores, invitaciones a partidos, administración de complejos/canchas y reservas automáticas vinculadas a partidos. Restricción estricta a fútbol en toda la plataforma.
